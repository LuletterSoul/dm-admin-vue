...
import Ins from  '../views/insturment/index'
/* login */
...
export const asyncRouterMap = [
  ...
  //     {
  //       path: 'digest',
  //       component: _import('datasets/digest'),
  //       name: '集合摘要',
  //       icon: 'survey',
  //       meta: {role: ['admin', 'teacher', 'student']}
  //     },
  //     {
  //       path: 'new',
  //       component: _import('datasets/upload'),
  //       name: '新增集合',
  //       icon: 'folder',
  ...
  //     {
  //       path: 'management',
  //       component: _import('datasets/edit'),
  //       name: '集合管理',
  //       icon: 'color-filling',
  //       meta: {role: ['admin', 'teacher']}
  //     },
  //     {
  //       path: 'set_detail',
  //       component: _import('datasets/detail'),
  //       name: '数据集详情',
  //       icon: 'survey1',
  //       hidden: true,
  //       meta: {role: ['admin', 'teacher']}
  ...
  //     {
  //       path: 'create',
  //       component: _import('tasks/create'),
  //       name: '新建任务',
  //       icon: 'home',
  //       meta: {role: ['admin', 'teacher']}
  //     },
  //     {
  //       path: 'tracking',
  //       component: _import('tasks/tracking'),
  //       name: '任务追踪',
  //       icon: 'home',
  //       hidden: true,
  //       meta: {role: ['admin', 'teacher']}
  ...
  //     {
  //       path: 'detail',
  //       component: _import('tasks/detail'),
  //       name: '任务信息',
  //       icon: 'home',
  //       hidden: true,
  //       meta: {role: ['admin', 'teacher']}
  ...
  //     {
  //       path: 'stutask',
  //       component: _import('tasks/stutask'),
  //       name: '任务信息',
  //       icon: 'home',
  //       hidden: true,
  //       meta: {role: ['student']}
  ...
  //       path: 'index',
  //       redirect: 'import',
  //       component: _import('datamining/index'),
  //       name: '挖掘首页',
  //       icon: 'exl',
  //       hidden: true,
  //       meta: {role: ['admin', 'teacher', 'student']}
  ...
  //     {
  //       path: 'import',
  //       component: _import('datamining/import'),
  //       name: '导入数据',
  //       icon: 'exl',
  //       meta: {role: ['admin', 'teacher', 'student']}
  //     },
  ...
  //         {
  //           path: 'density',
  //           component: _import('datamining/understand/density'),
  //           name: '密度分析',
  //           icon: 'libra',
  //           meta: {role: ['admin', 'teacher', 'student'], cache: 'density'}
  //         },
  //         {
  //           path: 'regression',
  //           component: _import('datamining/understand/regression'),
  //           name: '回归分析',
  //           icon: 'data',
  //           meta: {role: ['admin', 'teacher', 'student'], cache: 'regression'}
  //         },
  //         {
  //           path: 'corr',
  //           component: _import('datamining/understand/corr'),
  //           name: '关联分析',
  //           icon: 'process',
  //           meta: {role: ['admin', 'teacher', 'student'], cache: 'corr'}
  //         },
  //       ],
  //       meta: {
