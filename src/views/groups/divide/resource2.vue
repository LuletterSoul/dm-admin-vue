<template>
  <div class="calendar-list-container test">
    <div class="title">
      ...
      <el-row :gutter="20">
        <el-col :span="4">
          <el-input @keyup.enter.native="handleFilter" style="width: 200px;" @change='handleFilter'  placeholder="学号" v-model="listQuery.studentId" width="100%">
          </el-input>
        </el-col>
        <el-col :span="4">
          <el-select clearable style="width: 100px" @change='handleFilter'  v-model="listQuery.grade" placeholder="年级" width="100%">
            <el-option v-for="item in gradeOptions" :key="item" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-col>
        <el-col :span="4">
          <el-select clearable  @change='handleFilter' style="width: 130px" v-model="listQuery.className" placeholder="班级">
            <el-option v-for="item in  classNameOptions" :key="item.key" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-col>
        <el-col :span="4">
          <el-select @change='handleFilter' style="width: 120px"  v-model="listQuery.sort" placeholder="排序">
        ...
        <el-col :span="8">
          <el-button-group>
            ...
            <el-button type="primary" @click="handleCreate"  icon="el-icon-plus"></el-button>
            <el-button  type="primary" icon="el-icon-document" @click="handleDownload"></el-button>
            <el-button  type="primary" icon="el-icon-delete" v-waves @click="handleBatchDelete" :disabled="!multipleSelection.length"></el-button>
            <el-button  type="warning" icon="el-icon-star-on" v-waves @click="buildGroup" v-if="multipleSelection.length" ></el-button>
          </el-button-group>
        </el-col>
      </el-row>
      ...
      <!--<el-button class="btn-item" type="warning" icon="el-icon-star-on" v-waves @click="buildGroup" v-if="multipleSelection.length" >建立分组</el-button>-->
